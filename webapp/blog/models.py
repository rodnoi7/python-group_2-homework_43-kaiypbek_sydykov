...
class User(models.Model):
	...
	favorites = models.ManyToManyField("Article", through='Favorites', through_fields=('user', 'article'), related_name='favorite_articles', verbose_name='Favorites')
...
# def __str__(self):
 #        return "%s. %s - %s" % (self.pk, self.blog.blog, self.user.name)


class Comment(models.Model):
	author = models.ManyToManyField(User, related_name='comment_author', verbose_name='Author')
	article = models.ManyToManyField(Article, related_name='commented_article', verbose_name='Commented')
